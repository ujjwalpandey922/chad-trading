...
export function Navbar() {
  return (
    <header className="absolute inset-x-0 top-0 z-20 p-4">
      <nav className="mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="hidden sm:flex items-center gap-2 rounded-lg bg-btn-badge px-3 py-1.5 transition hover:bg-btn-badge-hover"
          >
            ...
            <div className="flex flex-col items-start leading-none">
              <span className="text-[10px] text-white/90 font-medium pb-0.5">
                Download on the
              </span>
          ...
          <button
            type="button"
            className="rounded-lg bg-btn-login px-5 py-2.5 text-base font-bold text-white transition hover:bg-black shadow-sm ring-1 ring-white/5"
            style={{
              textShadow:
